...
const Cart: React.FC<Props> = ({cartItems, setCartVisibility, setCartItems}) => {
  ...
  return (
    <div className="bg-smoke-darkest bg-opacity-50 z-50 absolute inset-0 flex justify-end">
      <div className="border-b md:border-l 2xl:border-l-2 2xl:border-b-2 bg-smoke-darkest h-modal max-w-full md:max-w-xl max-h-full md:max-h-96 flex flex-wrap justify-end items-end overflow-x-hidden overflow-scroll">
